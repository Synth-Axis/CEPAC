                ...
                <nav class="navbar">
                    ...
                    <ul class="itens animation">    
                        ...
                        <li class="drop">                                                    
                            ...
                            <div class="dropdown">                                  
                                ...
                                <a href="planos-relatorios-2022.php">PLANOS E RELATÓRIOS</a>
                                <a href="redes.php">REDES E PARCERIAS</a>
                            </div>
                        </li>    
                       ...
                       <!--  <li>
                            <a id="flex" href="atendimento-acompanhamento-social.php">
                                <div class="link">O QUE FAZEMOS</div>
                                <div class="icon-left">
                                    <img src="images/direita-castanho.png" alt="">
                                </div>
                    ...
                    <div class="right flex">
                        <!-- <div class="search-bar">
                            <form method="post" action="" class="flex nowrap">
                                <div>
                                    <input type="text" name="" placeholder="Pesquisa" aria-label="PESQUISA">
                                </div>
                                <div>    
                                    <button type="submit">
            ...
            <div class="phone">
                <a href="https://api.whatsapp.com/send?phone=+351962979900" target="_blank">
