$(document).ready(function () {
  ...
  $("#home .slider-banner").slick({
    ...
    pauseOnHover: false,
    prevArrow:
      '<div class="arrow"><span class="prev"><img src="images/anterior-branco.png" alt="Ícone de anterior"></span></div>',
    nextArrow:
      '<div class="arrow"><span class="arrow next"><img src="images/seguinte-branco.png" alt="Ícone de seguinte"></span></div>',
  });
  ...
  $(".slider-three").slick({
    ...
    pauseOnHover: false,
    prevArrow:
      '<div class="arrow"><span class="prev"><img src="images/anterior-azul.png" alt="Ícone de anterior"></span></div>',
    nextArrow:
      '<div class="arrow"><span class="arrow next"><img src="images/seguinte-azul.png" alt="Ícone de seguinte"></span></div>',
    responsive: [
      {
        breakpoint: 992,
        settings: {
...
// DINAMICALLY SHOW APOIOS

document.addEventListener("DOMContentLoaded", function () {
  let currentOpenContent = null;
  function toggleContent(linkId, contentId) {
    ...
    if (link && content) {
      link.addEventListener("click", function (event) {
        ...
        if (currentOpenContent && currentOpenContent !== content) {
          currentOpenContent.style.display = "none";
        }
  ...
  toggleContent("donativosLink", "aboutDonativos");
  toggleContent("consignacaoLink", "aboutConsignacao");
  toggleContent("herancaLink", "aboutHeranca");
  toggleContent("pagamentosTribunalLink", "aboutPagamentosTribunal");
  toggleContent("eventosSolidariosLink", "aboutEventos");
});
