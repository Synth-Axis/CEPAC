...
// VIEW NETWORK TEXT
    $query = $db->prepare("SELECT * FROM content WHERE tag = 'net' ");
    $query->execute();
...
?>
  ...
  <div class="main-content" id="panel">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Redes</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 m-0 p-0">
                                ...
                                <?php foreach($images as $img) : ?>
                                    ...
                                    <form action="controller/edit-networks.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <p class="mt-3">Tamanho: 215x100</p> 
                                        <div class="mt-4 mb-4">
                                            <input type="hidden" name="network_id" value="<?= $img['network_id']?>">
                                            <input type='hidden' name='oldimg' value='<?= $img['src']?>'>
                                            <button class='btn btn-primary m-4' name='edit-img' type='submit'>Editar</button>
                                            <button class='btn btn-danger' type="button" data-toggle='modal' data-id='<?= $img["network_id"];?>' data-src='<?= $img["src"];?>' data-target='#deleteNetwork'>Apagar</button>
                                        </div>
                                    </form>
                                    <hr>
                                <?php endforeach ?>
        ...
        <!-- Modal -->
        <div class="modal fade" id="deleteNetwork" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="deleteNetworkLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteNetworkLabel">Apagar</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger delete-network">Apagar</button>
                    </div>
                </div>
            </div>
        </div> 
