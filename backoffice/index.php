...
// VIEW HOME TEXT
    $query = $db->prepare("SELECT * FROM content WHERE tag = 'home' ");
    $query->execute();
...
?>
  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
                        ...
                        <div class="row ml-2 mr-2">
                            <div class="col-lg-6 col-md-12 col-sm-12 m-0 p-0">
                                <form action="controller/edit-home.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <p class="mt-3">Tamanho: 1920x800</p>
                                ...
                                <?php foreach($images as $img) : ?>
                                    ...
                                    <form action="controller/edit-home.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-4 mb-4">
                                            ...
                                            <button class='btn btn-danger' type="button" data-toggle='modal' data-id='<?= $img["img_id"];?>' data-src='<?= $img["src"];?>' data-target='#deleteHslider'>Apagar</button>
                                        </div>
                                    </form>
                                    <hr>
                                <?php endforeach ?>
        ...
        <!-- Modal -->
        <div class="modal fade" id="deleteHslider" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="deleteHsliderLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteHsliderLabel">Apagar</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger delete-hslider">Apagar</button>
                    </div>
                </div>
            </div>
        </div> 
