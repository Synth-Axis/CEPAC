...
// VIEW SUP TEXT
    $query = $db->prepare("SELECT * FROM content WHERE tag = 'sup' ");
    $query->execute();
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Apoiar</h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row ml-2 mr-2">
                            <div class="col-lg-6 col-md-12 col-sm-12 m-0 p-0">
                                ...
                                <form action="controller/edit-sup.php" method="post" enctype="multipart/form-data">
                                    <label>Título</label>
