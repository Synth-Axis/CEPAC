...
// VIEW PJ TEXT
    $query = $db->prepare("SELECT * FROM content WHERE tag = 'pj' ");
    $query->execute();
...
?>
  ...
  <div class="main-content" id="panel">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Projetos</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
                    ...
                    <div class="card-body">
                        <div class="row ml-2 mr-2">
                            <div class="col-lg-6 col-md-12 col-sm-12 m-0 p-0">
                                ...
                                <form action="controller/edit-pj.php" method="post" enctype="multipart/form-data">
                                    <label>Título</label>
                        ...
                        <div class="row ml-2 mr-2">
                            <div class="col-lg-6 col-md-12 col-sm-12 m-0 p-0">
                                <form action="controller/edit-pj.php" method="post" enctype="multipart/form-data">
                                    <h2 class="mb-4">Adicionar Projeto</h2> 
                                    <label>Número</label>
                                    <input type="number" name="porder" min="0" class="form-control mb-4 w-25" required>
                                    <label>Título</label>
                                    ...
                                    <button class='btn btn-primary m-4' name='add-project' type='submit'>Adicionar</button>
                                </form> 
                                <hr>
                                <?php foreach($projects as $project) : ?>
                                    ...
                                    <form action="controller/edit-pj.php" method="post" enctype="multipart/form-data">
                                        <label>Número</label>
                                        <input type="number" name="porder" min="0" class="form-control mb-4 w-25" value="<?= $project['porder']?>" required>
                                        <label>Título</label>
                                        <input type="text" name="title" min="0" class="form-control mb-4" value="<?= $project['title']?>" required>
                                        <label>Texto</label>
                                        <textarea rows="15" name="text" class="form-control mytextarea" ><?= $project["text"]; ?></textarea>
                                        <div class="mt-4 mb-4">
                                            <input type="hidden" name="project_id" value="<?= $project['project_id']?>">
                                            <button class='btn btn-primary m-4' name='edit-project' type='submit'>Editar</button>
                                            <button class='btn btn-danger' type="button" data-toggle='modal' data-id='<?= $project["project_id"];?>' data-target='#deleteProject'>Apagar</button>
                                        </div>
                                    </form>
                                    <hr>
                                <?php endforeach ?>
                                ...
                                <?php foreach($images as $img) : ?>
                                    ...
                                    <form action="controller/edit-pj.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-4 mb-4">
                                            ...
                                            <button class='btn btn-danger' type="button" data-toggle='modal' data-id='<?= $img["img_id"];?>' data-src='<?= $img["src"];?>' data-target='#deletePj'>Apagar</button>
                                        </div>
                                    </form>
                                    <hr>
                                <?php endforeach ?>
        ...
        <!-- Modal -->
        <div class="modal fade" id="deleteProject" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="deleteProjectLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteProjectLabel">Apagar</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger delete-project">Apagar</button>
                    </div>
                </div>
            </div>
        </div> 
        <!-- Modal -->
        <div class="modal fade" id="deletePj" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="deletePjLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deletePjLabel">Apagar</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="id" class="modal-id">
                        <button type="button" class="btn btn-danger delete-pj">Apagar</button>
                    </div>
                </div>
            </div>
        </div> 
