...
// VIEW SV TEXT
    $query = $db->prepare("SELECT * FROM content WHERE tag = 'sv' ");
    $query->execute();
...
?>
  ...
  <div class="main-content" id="panel">
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Serviço de Voluntariado</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
                    ...
                    <div class="card-body">
                        <div class="row ml-2 mr-2">
                            <div class="col-lg-6 col-md-12 col-sm-12 m-0 p-0">
                                ...
                                <form action="controller/edit-sv.php" method="post" enctype="multipart/form-data">
                                    <label>Título</label>
                                ...
                                <?php foreach($images as $img) : ?>
                                    ...
                                    <form action="controller/edit-sv.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mt-4 mb-4">
                                            ...
                                            <button class='btn btn-danger' type="button" data-toggle='modal' data-id='<?= $img["img_id"];?>' data-src='<?= $img["src"];?>' data-target='#deleteSv'>Apagar</button>
                                        </div>
                                    </form>
                                    <hr>
                                <?php endforeach ?>
        ...
        <!-- Modal -->
        <div class="modal fade" id="deleteSv" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="deleteSvLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteSvLabel">Apagar</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger delete-sv">Apagar</button>
                    </div>
                </div>
            </div>
        </div> 
